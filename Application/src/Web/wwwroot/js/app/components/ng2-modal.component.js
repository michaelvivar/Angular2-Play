...
var ModalComponent = (function () {
    ...
    ModalComponent.prototype.hide = function (data) {
        if (this.Modal.isShown) {
            this.Modal.hide();
            this.close.emit();
        }
    };
    ModalComponent.prototype.btn = function () {
        this.save.emit();
    };
    __decorate([
        core_1.Input(), 
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], ModalComponent.prototype, "button", void 0);
    __decorate([
        core_1.Output(), 
...
//# sourceMappingURL=ng2-modal.component.js.map